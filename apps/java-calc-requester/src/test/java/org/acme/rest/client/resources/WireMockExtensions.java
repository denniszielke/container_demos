...
public class WireMockExtensions implements QuarkusTestResourceLifecycleManager {
    ...
    private static final String COUNTRIES_JSON_FILE = "/calculations.json";
    ...
    public Map<String, String> start() {
        ...
        stubExtensions();
        return Collections.singletonMap("quarkus.rest-client.\"org.acme.rest.client.CalculationService\".url",
